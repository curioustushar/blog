...
> GitHub submission mirror of the [live blog post](https://curioustushar.github.io/blog/posts/the-mixture-is-the-model-2-5t-pretraining-plan/).
> **Proxy results:** [scripts/mixture_proxy_results.json](../scripts/mixture_proxy_results.json)

**Status:** Spec complete · Loader sim ✓ · Benchmark proxy pending · Data-gated (P0/P1)
...
3. **Locally verified** — inspected in-repo or on disk (today: AyAI reasoning subset only — 15.1M rows from [cleaning blog](https://curioustushar.github.io/blog/posts/data-cleaning-strategies-applied/)).
...
**Total budget: 2.5T tokens** — aligned with the [40B model design](https://curioustushar.github.io/blog/posts/train-40b-model-design/) pretraining target, not an arbitrary round number.
...
| **P2** | Reasoning | Reasoning lane | 150B | **85B** AON inventory + **15.1M** AyAI rows cleaned ([cleaning blog](https://curioustushar.github.io/blog/posts/data-cleaning-strategies-applied/): 22.2M→15.1M, ~68% survival, manifests generated) | ~65B @ 2.5T | Pipeline **proven** on 22M-row set; scale-up in progress |
